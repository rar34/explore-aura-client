            ...
            <div className="hero-content">
                ...
                <div className="card shrink-0 w-full p-2 md:p-6 bg-base-100">
                    ...
                    <div data-aos="fade-down" data-aos-delay="400" className="px-6 py-2">
                        ...
                        <button data-aos="fade-left" data-aos-delay="400" className="rounded-lg flex items-center btn btn-success w-full md:w-full p-2 mx-auto text-center text-white mb-4"><FaGithub className="text-xl" /> Continue with gitHub</button>
