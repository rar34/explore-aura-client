...
const NewsLetter = () => {
    ...
    return (
        ...
        data-aos-duration="2000" className="min-h-96 flex items-center p-3 justify-center my-14 rounded-xl" style={{ backgroundImage: 'url(https://i.ibb.co/fFBT7Xr/coxsbazar.jpg)' }}>
